...
/** Main Game Class and Starting Point **/
public class NopeIslandGame extends ApplicationAdapter implements InputProcessor, GestureDetector.GestureListener {
  ...
  /** The 32 pixel size still hard coded. This must change. We shall load this information from a
   config file and use through all the game. */

  // Graph Map
  private GraphMap graph_map;
  /** This is the graph where all things findable in the game world are. It will be used by many
   algorithms, like pathfinding and AI. */
  ...
  /** The default tiled map render from LibGDX is weird.
   ...
   May consider changing this on future. Maybe. */
  ...
  // Batch render for most drawable things
  SpriteBatch batch;
